...
const socials = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/greylynwayne/",
    icon: (
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/greylynwayne/",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Pinterest",
    href: "https://www.pinterest.com/greylynwaynepdx/",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@greylynwayneinteriors",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              Transforming spaces into stunning showcases since 2015.
            </p>
          </div>
